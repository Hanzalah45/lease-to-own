...
const TYPE_STYLE: Record<string, { icon: ComponentType<SVGProps<SVGSVGElement>>; tone: string; label: string }> = {
  ...
  account_setup: { icon: UserIcon, tone: "bg-blue-50 text-blue-500", label: "Account" },
  ...
  contract_voided: { icon: AlertCircleIcon, tone: "bg-amber-50 text-amber-600", label: "Contract" },
  contract_signature_requested: { icon: DocumentIcon, tone: "bg-amber-50 text-amber-600", label: "Contract" },
  contract_pdf_failed: { icon: AlertCircleIcon, tone: "bg-red-50 text-red-600", label: "Contract" },
  deposit_forfeited: { icon: AlertCircleIcon, tone: "bg-red-50 text-red-600", label: "Deposit" },
  ...
  background_check: { icon: ShieldIcon, tone: "bg-blue-50 text-blue-500", label: "Risk" },
  bank_verified: { icon: ShieldIcon, tone: "bg-green-50 text-green-600", label: "Risk" },
  bank_verification_requested: { icon: ShieldIcon, tone: "bg-amber-50 text-amber-600", label: "Risk" },
